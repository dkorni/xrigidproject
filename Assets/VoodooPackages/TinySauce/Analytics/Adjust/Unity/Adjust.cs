...
namespace com.adjust.sdk
{
    public class Adjust : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if(appToken == "")
            {
                throw new MissingFieldException("go here",new Exception("No Adjust App Token found please add it to your Tiny Sauce Settings"));
                Debug.Break();
                return;
            }
            print(appToken + appToken.Length);
            if (IsEditor()) { return; }
